...
<div class="container">
	<div style="width:100%;">
		...
		<div style="float:right; margin-top:20px;">
			<input type="button" class="btn btn-default" value="뒤로가기" onclick="location.href='<%=request.getContextPath()%>/admin/ft/ft_list.do'">
		</div>
	</div>
    <div style="border-bottom:1px solid #444444; margin-top:15px; clear:both;"></div>
	<div style="margin-top:15px; margin-bottom:25px;">
        <form class="form-inline" action="<%=request.getContextPath()%>/admin/ft/ft_search_list.do" method="GET"> 
            <div class="form-group"> 
            	<h4>푸드트럭 검색</h4>
                    <select class="form-control" name="option">
                        <option value="ft_name">푸드트럭 이름</option>
                        <option value="sel_no">사업자 번호</option>
                    </select>
	...
	<div id="table_container">
		<%@ include file="ft_search_table.jsp" %>
