...
<body>
	...
	<form name="review_edit_form" method="post" action="<%=request.getContextPath()%>/seller/ft/ft_review_edit.do" enctype="multipart/form-data">
	...
	<div align="center">
		<input type="button"  value="취소" class="btn btn-default" style="width:80px;" onClick="location.href='<%=request.getContextPath()%>/seller/ft/ft_info.do?cmd=review_info&ft_seq=<%=revDTO.getFt_seq()%>&review_seq=<%=revDTO.getReview_seq()%>'">
