...
<link rel="canonical" href="https://codepen.io/suez/pen/dPqxoM">
...
.cont {
  position: relative;
  height: 100%;
  background-image: url("<%=request.getContextPath()%>/resources/img/admin/admin_login_bg.jpg");
...
.login {
  position: relative;
  height: 100%;
  background: linear-gradient(to bottom, rgba(0, 0, 15, 0.6) 0%, rgba(0, 0, 15, 0.6) 30%);
    ...
    <div class="app">
      <div class="app__top">
        ...
        <svg class="app__icon search svg-icon" viewBox="0 0 20 20">
          ...
          <path d="M20,20 15.36,15.36 a9,9 0 0,1 -12.72,-12.72 a 9,9 0 0,1 12.72,12.72"></path>
        </svg>
