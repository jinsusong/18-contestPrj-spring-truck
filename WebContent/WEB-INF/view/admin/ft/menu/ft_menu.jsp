...
<body>
			...
			<div style="float:right; width:30%; height:42px; text-align:right; padding-top:15px;">
				<input type="button" class="btn btn-default" value="카테고리 설정" onclick="location.href='<%=request.getContextPath()%>/admin/ft/ft_info.do?cmd=category_list&ft_seq=<%=ftDTO2.getFt_seq()%>'">
			</div>
