...
sojaeji.prototype = {
 ...
 '시도' : ['서울','부산','대구','인천','광주','대전','울산','강원','경기','경상남도','경상북도','전라남도','전라북도','제주','충청남도','충청북도'],
 ...
 '경상남도->거제시' : ['고현동','능포동','덕포동','두모동','마전동','문동동','삼거동','상동동','수월동','아양동','아주동','양정동','옥포1동','옥포2동','옥포동','장승포동','장평동','거제면','남부면','동부면','둔덕면','사등면','연초면','일운면','장목면','하청면','장승포우체국사서함'],
 '경상남도->김해시' : ['강동','구산동','내동','대성동','동상동','명법동','봉황동','부원동','불암동','삼계동','삼방동','삼정동','서상동','안동','어방동','외동','이동','전하동','지내동','풍유동','화목동','흥동','진영읍','대동면','상동면','생림면','장유면','주촌면','진례면','한림면','김해우체국사서함'],
 ...
 '경상남도->밀양시' : ['가곡동','교동','남포동','내이동','내일동','삼문동','용평동','활성동','삼랑진읍','하남읍','단장면','무안면','부북면','산내면','산외면','상남면','상동면','청도면','초동면','밀양우체국사서함'],
 '경상남도->사천시' : ['궁지동','노룡동','늑도동','대방동','대포동','동금동','동동','동림동','마도동','백천동','벌리동','봉남동','사등동','서금동','서동','선구동','송포동','신벽동','신수동','실안동','와룡동','용강동','이금동','이홀동','좌룡동','죽림동','향촌동','사천읍','곤명면','곤양면','사남면','서포면','용현면','정동면','축동면','삼천포우체국사서함'],
 '경상남도->양산시' : ['교동','남부동','다방동','덕계동','매곡동','명곡동','명동','북부동','북정동','산막동','삼호동','소주동','신기동','어곡동','용당동','유산동','주남동','주진동','중부동','평산동','호계동','물금읍','동면','상북면','원동면','하북면','양산우체국사서함'],
 '경상남도->진주시' : ['가좌동','강남동','계동','귀곡동','남성동','대안동','동성동','망경동','본성동','봉곡동','봉래동','상대1동','상대2동','상대동','상봉동동','상봉서동','상봉동','상평동','수정동','신안동','옥봉동','유곡동','이현동','인사동','장대동','장재동','주약동','중안동','초전동','칠암동','판문동','평거동','평안동','하대1동','하대2동','하대동','하촌동','호탄동','문산읍','금곡면','금산면','내동면','대곡면','대평면','명석면','미천면','사봉면','수곡면','이반성면','일반성면','정촌면','지수면','진성면','집현면','진주우체국사서함'],
 '경상남도->진해시' : ['가주동','경화동','광화동','근화동','남문동','남빈동','남양동','대영동','대장동','대죽동','대천동','대흥동','덕산동','도만동','도천동','동상동','두동','마천동','명동','무송동','부흥동','북부동','비봉동','서중동','석동','성내동','소사동','속천동','송죽동','송학동','수도동','수송동','숭인동','신흥동','안곡동','안골동','앵곡동','여좌동','연도동','용원동','원포동','이동','익선동','인사동','인의동','자은동','장천동','제덕동','제황산동','죽곡동','중앙동','중평동','창선동','청안동','충무동','충의동','태백동','태평동','통신동','평안동','풍호동','행암동','현동','화천동','회현동','진해우체국사서함'],
 '경상남도->창원시' : ['가음동','가음정동','귀곡동','귀산동','귀현동','남산동','남양동','남지동','내동','내리동','대방동','대원동','덕정동','도계동','동정동','두대동','명곡동','명서동','반계동','반림동','반송동','반지동','봉곡동','봉림동','북동','불모산동','사림동','사파동','사파정동','사화동','삼동동','삼정자동','상남동','상복동','서곡동','서상동','성산동','성주동','소계동','소답동','신월동','신촌동','안민동','양곡동','완암동','외동','용동','용호동','용지동','웅남동','월림동','적현동','중동','중앙동','지귀동','차룡동','창곡동','천선동','토월동','퇴촌동','팔용동','동읍','대산면','북면','창원우체국사서함'],
 '경상남도->통영시' : ['당동','도남동','도천동','동호동','명정동','무전동','문화동','미수1동','미수2동','미수동','봉평동','북신동','서호동','인평동','정량동','중앙동','태평동','평림동','항남동','산양읍','광도면','도산면','사량면','욕지면','용남면','한산면','통영우체국사서함'],
 '경상남도->거창군' : ['거창읍','가북면','가조면','고제면','남상면','남하면','마리면','북상면','신원면','웅양면','위천면','주상면'],
 '경상남도->고성군' : ['고성읍','개천면','거류면','구만면','대가면','동해면','마암면','삼산면','상리면','영오면','영현면','하이면','하일면','회화면'],
 '경상남도->남해군' : ['남해읍','고현면','남면','미조면','삼동면','상주면','서면','설천면','이동면','창선면'],
 '경상남도->산청군' : ['산청읍','금서면','단성면','삼장면','생비량면','생초면','시천면','신등면','신안면','오부면','차황면'],
 '경상남도->의령군' : ['의령읍','가례면','궁류면','낙서면','대의면','봉수면','부림면','용덕면','유곡면','정곡면','지정면','칠곡면','화정면'],
 '경상남도->창녕군' : ['남지읍','창녕읍','계성면','고암면','길곡면','대지면','대합면','도천면','부곡면','성산면','영산면','유어면','이방면','장마면'],
 '경상남도->하동군' : ['하동읍','고전면','금남면','금성면','북천면','악양면','양보면','옥종면','적량면','진교면','청암면','화개면','횡천면'],
 '경상남도->함안군' : ['가야읍','군북면','대산면','법수면','산인면','여항면','칠북면','칠서면','칠원면','함안면'],
 '경상남도->함양군' : ['함양읍','마천면','백전면','병곡면','서상면','서하면','수동면','안의면','유림면','지곡면','휴천면'],
 '경상남도->합천군' : ['합천읍','가야면','가회면','대병면','대양면','덕곡면','묘산면','봉산면','삼가면','쌍백면','쌍책면','야로면','용주면','율곡면','적중면','청덕면','초계면'],
 '경상북도->경산시' : ['갑제동','계양동','남방동','내동','대동','대정동','대평동','백천동','사동','사정동','삼남동','삼북동','삼풍동','상방동','서상동','신교동','신천동','여천동','옥곡동','옥산동','유곡동','임당동','점촌동','정평동','조영동','중방동','중산동','평산동','진량읍','하양읍','남산면','남천면','압량면','와촌면','용성면','자인면','경산우체국사서함'],
 '경상북도->경주시' : ['광명동','교동','구정동','구황동','남산동','노동동','노서동','덕동','도지동','동방동','동부동','동천동','마동','배동','배반동','보문동','북군동','북부동','사정동','서부동','서악동','석장동','성건동','성동동','손곡동','시동','시래동','신평동','암곡동','용강동','율동','인왕동','조양동','진현동','천군동','충효동','탑동','평동','하동','황남동','황성동','황오동','황용동','효현동','감포읍','건천읍','안강읍','외동읍','강동면','내남면','산내면','서면','양남면','양북면','천북면','현곡면','경주우체국사서함'],
 '경상북도->구미시' : ['거의동','공단1동','공단2동','공단동','광평동','구평동','구포동','금전동','남통동','도량동','봉곡동','부곡동','비산동','사곡동','상모동','선기동','송정동','수점동','시미동','신동','신평1동','신평2동','신평동','양호동','오태동','옥계동','원평1동','원평2동','원평동','인의동','임수동','임은동','지산동','진평동','형곡1동','형곡2동','형곡동','황상동','고아읍','선산읍','도개면','무을면','산동면','옥성면','장천면','해평면','구미우체국사서함'],
 '경상북도->김천시' : ['감호동','교동','남산동','다수동','대광동','덕곡동','모암동','문당동','백옥동','부곡동','삼락동','성내동','신음동','양천동','용두동','응명동','지좌동','평화동','황금동','아포읍','감문면','감천면','개령면','구성면','남면','농소면','대덕면','대항면','봉산면','부항면','어모면','조마면','증산면','지례면','김천우체국사서함'],
 '경상북도->문경시' : ['공평동','모전동','불정동','신기동','영신동','우지동','유곡동','윤직동','점촌동','창동','흥덕동','가은읍','문경읍','농암면','동로면','마성면','산북면','산양면','영순면','호계면','문경우체국사서함'],
 '경상북도->상주시' : ['가장동','개운동','거동동','계산동','낙상동','낙양동','남성동','남장동','남적동','냉림동','도남동','만산동','무양동','병성동','복룡동','부원동','서곡동','서문동','서성동','성동동','성하동','신봉동','양촌동','연원동','오대동','외답동','인봉동','인평동','죽전동','중덕동','지천동','초산동','헌신동','화개동','화산동','흥각동','함창읍','공검면','공성면','낙동면','내서면','모동면','모서면','사벌면','외남면','외서면','은척면','이안면','중동면','청리면','화남면','화동면','화북면','화서면','상주우체국사서함'],
 '경상북도->안동시' : ['광석동','금곡동','남문동','남부동','노하동','당북동','대석동','동문동','동부동','명륜동','목성동','법상동','법흥동','북문동','삼산동','상아동','서부동','석동동','성곡동','송천동','송현동','수상동','수하동','신세동','신안동','안기동','안막동','안흥동','옥동','옥야동','옥정동','용상동','운안동','운흥동','율세동','이천동','정상동','정하동','천리동','태화동','평화동','화성동','풍산읍','길안면','남선면','남후면','녹전면','도산면','북후면','서후면','예안면','와룡면','일직면','임동면','임하면','풍천면','안동우체국사서함'],
 '경상북도->영주시' : ['가흥1동','가흥2동','가흥동','고현동','문정동','상망동','상줄동','아지동','영주1동','영주2동','영주동','적서동','조암동','조와동','창진동','하망동','휴천1동','휴천2동','휴천3동','휴천동','풍기읍','단산면','문수면','봉현면','부석면','순흥면','안정면','이산면','장수면','평은면','영주우체국사서함'],
 '경상북도->영천시' : ['과전동','괴연동','교촌동','금노동','녹전동','대전동','도남동','도동','도림동','망정동','매산동','문내동','문외동','범어동','본촌동','봉동','서산동','성내동','신기동','쌍계동','야사동','언하동','오미동','오수동','완산동','작산동','조교동','창구동','채신동','화룡동','금호읍','고경면','대창면','북안면','신녕면','임고면','자양면','청통면','화남면','화북면','화산면','영천우체국사서함'],
 '경상북도->포항시 남구' : ['괴동동','대도동','대잠동','동촌동','상도동','송내동','송도동','송정동','이동','인덕동','일월동','장흥동','지곡동','청림동','해도동','호동','효자동','구룡포읍','연일읍','오천읍','대보면','대송면','동해면','장기면','포항우체국사서함'],
 '경상북도->포항시 북구' : ['남빈동','대신동','대흥동','덕산동','덕수동','동빈1가','동빈2가','두호동','득량동','상원동','신흥동','양덕동','여남동','여천동','용흥동','우현동','장성동','죽도동','중앙동','창포동','학산동','학잠동','항구동','환호동','흥해읍','기계면','기북면','송라면','신광면','죽장면','청하면'],
 '경상북도->고령군' : ['고령읍','개진면','다산면','덕곡면','성산면','쌍림면','우곡면','운수면'],
 '경상북도->군위군' : ['군위읍','고로면','부계면','산성면','소보면','우보면','의흥면','효령면'],
 '경상북도->봉화군' : ['봉화읍','명호면','물야면','법전면','봉성면','상운면','석포면','소천면','재산면','춘양면'],
 '경상북도->성주군' : ['성주읍','가천면','금수면','대가면','벽진면','선남면','수륜면','용암면','월항면','초전면'],
 '경상북도->영덕군' : ['영덕읍','강구면','남정면','달산면','병곡면','영해면','지품면','창수면','축산면'],
 '경상북도->영양군' : ['영양읍','석보면','수비면','일월면','입암면','청기면'],
 '경상북도->예천군' : ['예천읍','감천면','개포면','보문면','상리면','용궁면','용문면','유천면','지보면','풍양면','하리면','호명면'],
 '경상북도->울릉군' : ['울릉읍','북면','서면'],
 '경상북도->울진군' : ['울진읍','평해읍','근남면','기성면','북면','서면','온정면','원남면','죽변면','후포면'],
 '경상북도->의성군' : ['의성읍','가음면','구천면','금성면','다인면','단밀면','단북면','단촌면','봉양면','비안면','사곡면','신평면','안계면','안사면','안평면','옥산면','점곡면','춘산면'],
 '경상북도->청도군' : ['청도읍','화양읍','각남면','각북면','금천면','매전면','운문면','이서면','풍각면'],
 '경상북도->청송군' : ['청송읍','부남면','부동면','안덕면','진보면','파천면','현동면','현서면'],
 '경상북도->칠곡군' : ['북삼읍','석적읍','왜관읍','가산면','기산면','동명면','약목면','지천면'],
 '전라남도->광양시' : ['광영동','금호동','도이동','마동','성황동','중군동','중동','태인동','황금동','황길동','광양읍','다압면','봉강면','옥곡면','옥룡면','진상면','진월면','광양우체국사서함','목성우체국사서함'],
 '전라남도->나주시' : ['경현동','과원동','관정동','교동','금계동','금성동','남내동','남외동','대기동','대호동','동수동','보산동','부덕동','산정동','삼도동','삼영동','서내동','석현동','성북동','송월동','송촌동','안창동','영산동','오량동','용산동','운곡동','이창동','죽림동','중앙동','진포동','청동','토계동','평산동','남평읍','공산면','금천면','노안면','다도면','다시면','동강면','문평면','반남면','봉황면','산포면','세지면','왕곡면','나주우체국사서함','남평우체국사서함','성북동우체국사서함'],
 '전라남도->목포시' : ['경동1가','경동2가','경동','광동1가','광동2가','광동3가','광동','금동1가','금동2가','금동','금화동','남교동','달동','대성동','대안동','대양동','대의동1가','대의동2가','대의동3가','대의동','동명동','만호동','명륜동','무안동','보광동1가','보광동2가','보광동3가','보광동','복만동','부흥동','북교동','북항동','산정1동','산정2동','산정3동','산정동','삼학동','상동','상락동1가','상락동2가','상락동','서산동','석현동','수강동1가','수강동2가','수강동','신흥동','양동','연산동','영해동1가','영해동2가','영해동','옥암동','온금동','용당1동','용당2동','용당동','용해동','원산동','유동','유달동','율도동','죽교동','죽동','중동1가','중동2가','중동','중앙동1가','중앙동2가','중앙동3가','중앙동','창평동','축복동1가','축복동2가','축복동3가','축복동','측후동','하당동','항동','해안동1가','해안동2가','해안동3가','해안동4가','해안동','행복동1가','행복동2가','행복동','호남동','목포우체국사서함'],
 '전라남도->순천시' : ['가곡동','교량동','금곡동','남내동','남정동','대대동','대룡동','덕암동','덕월동','동외동','매곡동','삼거동','생목동','석현동','안풍동','야흥동','연향동','영동','오천동','옥천동','와룡동','왕지동','용당동','인월동','인제동','장천동','저전동','조곡동','조례동','중앙동','풍덕동','행동','홍내동','승주읍','낙안면','별량면','상사면','서면','송광면','외서면','월등면','주암면','해룡면','황전면','순천우체국사서함'],
 '전라남도->여수시' : ['경호동','고소동','공화동','관문동','광무동','교동','국동','군자동','낙포동','남산동','덕충동','동산동','둔덕동','만흥동','묘도동','문수동','미평동','봉강동','봉계동','봉산동','상암동','서교동','선원동','소호동','수정동','시전동','신기동','신덕동','신월동','안산동','여서동','여천동','연등동','오림동','오천동','웅천동','월내동','월하동','적량동','종화동','주삼동','중앙동','중흥동','충무동','평여동','학동','학용동','해산동','호명동','화장동','화치동','돌산읍','남면','삼산면','소라면','율촌면','화양면','화정면','여수우체국사서함'],
 '전라남도->강진군' : ['강진읍','군동면','대구면','도암면','마량면','병영면','성전면','신전면','옴천면','작천면','칠량면'],
 '전라남도->고흥군' : ['고흥읍','도양읍','과역면','금산면','남양면','대서면','도덕면','도화면','동강면','동일면','두원면','봉래면','영남면','점암면','포두면','풍양면'],
 '전라남도->곡성군' : ['곡성읍','겸면','고달면','목사동면','삼기면','석곡면','오곡면','오산면','옥과면','입면','죽곡면'],
 '전라남도->구례군' : ['구례읍','간전면','광의면','마산면','문척면','산동면','용방면','토지면'],
 '전라남도->담양군' : ['담양읍','고서면','금성면','남면','대덕면','대전면','무정면','봉산면','수북면','용면','월산면','창평면'],
 '전라남도->무안군' : ['무안읍','망운면','몽탄면','삼향면','운남면','일로읍','청계면','해제면','현경면'],
 '전라남도->보성군' : ['벌교읍','보성읍','겸백면','노동면','득량면','문덕면','미력면','복내면','웅치면','율어면','조성면','회천면'],
 '전라남도->신안군' : ['지도읍','도초면','비금면','신의면','안좌면','암태면','압해면','임자면','자은면','장산면','증도면','팔금면','하의면','흑산면'],
 '전라남도->영광군' : ['백수읍','영광읍','홍농읍','군남면','군서면','낙월면','대마면','묘량면','법성면','불갑면','염산면'],
 '전라남도->영암군' : ['삼호읍','영암읍','군서면','금정면','덕진면','도포면','미암면','서호면','시종면','신북면','학산면'],
 '전라남도->완도군' : ['금일읍','노화읍','완도읍','고금면','군외면','금당면','보길면','생일면','소안면','신지면','약산면','청산면'],
 '전라남도->장성군' : ['장성읍','남면','동화면','북이면','북일면','북하면','삼계면','삼서면','서삼면','진원면','황룡면'],
 '전라남도->장흥군' : ['관산읍','대덕읍','장흥읍','부산면','안양면','용산면','유치면','장동면','장평면','회진면'],
 '전라남도->진도군' : ['진도읍','고군면','군내면','의신면','임회면','조도면','지산면'],
 '전라남도->함평군' : ['함평읍','나산면','대동면','손불면','신광면','엄다면','월야면','학교면','해보면'],
 '전라남도->해남군' : ['해남읍','계곡면','마산면','문내면','북일면','북평면','산이면','삼산면','송지면','옥천면','현산면','화산면','화원면','황산면'],
 '전라남도->화순군' : ['화순읍','남면','능주면','도곡면','도암면','동면','동복면','북면','이서면','이양면','청풍면','춘양면','한천면'],
 '전라북도->군산시' : ['개복동','개사동','개정동','경암동','경장동','구암동','금동','금광동','금암동','나운1동','나운2동','나운3동','나운동','내초동','내흥동','대명동','동흥남동','둔율동','명산동','문화동','미룡동','미원동','미장동','비응도동','사정동','산북동','삼학동','서흥남동','선양동','소룡동','송창동','송풍동','수송동','신관동','신영동','신창동','신풍동','신흥동','영동','영화동','오룡동','오식도동','월명동','장미동','장재동','조촌동','죽성동','중동','중앙로1가','중앙로2가','중앙로3가','지곡동','창성동','평화동','해망동','옥구읍','개정면','나포면','대야면','서수면','성산면','옥도면','옥산면','옥서면','임피면','회현면','군산우체국사서함'],
 '전라북도->김제시' : ['갈공동','검산동','교동','난봉동','도장동','명덕동','백학동','복죽동','상동동','서암동','서정동','순동','신곡동','신덕동','신월동','신풍동','양전동','연정동','오정동','옥산동','요촌동','용동','월봉동','월성동','입석동','장화동','제월동','하동','황산동','흥사동','만경읍','공덕면','광활면','금구면','금산면','백구면','백산면','봉남면','부량면','성덕면','용지면','죽산면','진봉면','청하면','황산면','김제우체국사서함'],
 '전라북도->남원시' : ['갈치동','고죽동','광치동','금동','내척동','노암동','도통동','동충동','산곡동','식정동','신정동','신촌동','쌍교동','어현동','왕정동','용정동','월락동','조산동','죽항동','천거동','하정동','향교동','화정동','운봉읍','금지면','대강면','대산면','덕과면','보절면','사매면','산내면','산동면','송동면','수지면','아영면','이백면','인월면','주생면','주천면','남원우체국사서함'],
 '전라북도->익산시' : ['갈산동','금강동','남중동','덕기동','동산동','마동','만석동','모현동1가','모현동2가','목천동','부송동','석암동','석왕동','석탄동','송학동','신동','신용동','신흥동','어양동','영등동','용제동','월성동','은기동','인화동1가','인화동2가','인화동','임상동','정족동','주현동','중앙동1가','중앙동2가','중앙동3가','중앙동','창인동1가','창인동2가','창인동','팔봉동','평화동','현영동','함열읍','금마면','낭산면','망성면','삼기면','성당면','여산면','오산면','왕궁면','용동면','용안면','웅포면','춘포면','함라면','황등면','익산우체국사서함','익산공단우체국사서함'],
 '전라북도->전주시 덕진구' : ['강흥동','고랑동','금상동','금암1동','금암2동','금암동','남정동','덕진동1가','덕진동2가','도덕동','도도동','동산동','만성동','반월동','산정동','성덕동','송천동1가','송천동2가','여의동','용정동','우아동1가','우아동2가','우아동3가','원동','인후동1가','인후동2가','장동','전미동1가','전미동2가','진북동','팔복동1가','팔복동2가','팔복동3가','팔복동4가','호성동1가','호성동2가','호성동3가','화전동','동전주우체국사서함'],
 '전라북도->전주시 완산구' : ['경원동1가','경원동2가','경원동3가','고사동','교동','남노송동','다가동1가','다가동2가','다가동3가','다가동4가','대성동','동서학동','동완산동','삼천동1가','삼천동2가','삼천동3가','상림동','색장동','서노송동','서서학동','서신동','서완산동1가','서완산동2가','석구동','용복동','원당동','전동','전동3가','중노송동','중동','중앙동1가','중앙동2가','중앙동3가','중앙동4가','중인동','중화산동1가','중화산동2가','태평동','평화동1가','평화동2가','평화동3가','풍남동1가','풍남동2가','풍남동3가','효자동1가','효자동2가','효자동3가','전주우체국사서함'],
 '전라북도->정읍시' : ['공평동','과교동','교암동','구룡동','금붕동','내장동','농소동','망제동','부전동','삼산동','상동','상평동','송산동','수성동','시기3동','시기동','신월동','신정동','쌍암동','연지동','영파동','용계동','용산동','장명동','진산동','하모동','하북동','흑암동','신태인읍','감곡면','고부면','덕천면','북면','산내면','산외면','소성면','영원면','옹동면','이평면','입암면','정우면','칠보면','태인면','정읍우체국사서함'],
 '전라북도->고창군' : ['고창읍','고수면','공음면','대산면','무장면','부안면','상하면','성내면','성송면','신림면','심원면','아산면','해리면','흥덕면'],
 '전라북도->무주군' : ['무주읍','무풍면','부남면','설천면','안성면','적상면'],
 '전라북도->부안군' : ['부안읍','계화면','동진면','백산면','변산면','보안면','상서면','위도면','주산면','줄포면','진서면','하서면','행안면'],
 '전라북도->순창군' : ['순창읍','구림면','금과면','동계면','복흥면','쌍치면','유등면','인계면','적성면','팔덕면','풍산면'],
 '전라북도->완주군' : ['봉동읍','삼례읍','경천면','고산면','구이면','동상면','비봉면','상관면','소양면','용진면','운주면','이서면','화산면'],
 '전라북도->임실군' : ['임실읍','강진면','관촌면','덕치면','삼계면','성수면','신덕면','신평면','오수면','운암면','지사면','청웅면'],
 '전라북도->장수군' : ['장수읍','계남면','계북면','번암면','산서면','장계면','천천면'],
 '전라북도->진안군' : ['진안읍','동향면','마령면','백운면','부귀면','상전면','성수면','안천면','용담면','정천면','주천면'],
 ...
 '충청남도->계룡시' : ['금암동','두마면','신도안면','엄사면'],
 '충청남도->공주시' : ['검상동','교동','금성동','금학동','금흥동','무릉동','반죽동','봉정동','봉황동','산성동','상왕동','소학동','신관동','신기동','쌍신동','오곡동','옥룡동','웅진동','월미동','월송동','주미동','중동','중학동','태봉동','유구읍','계룡면','반포면','사곡면','신풍면','우성면','의당면','이인면','장기면','정안면','탄천면','공주우체국사서함'],
 '충청남도->논산시' : ['강산동','관촉동','내동','대교동','덕지동','등화동','반월동','부창동','지산동','취암동','화지동','강경읍','연무읍','가야곡면','광석면','노성면','벌곡면','부적면','상월면','성동면','양촌면','연산면','은진면','채운면','논산우체국사서함'],
 '충청남도->보령시' : ['궁촌동','남곡동','내항동','대천1동','대천2동','대천동','동대동','명천동','신흑동','요암동','죽정동','화산동','웅천읍','남포면','미산면','성주면','오천면','주교면','주산면','주포면','천북면','청라면','청소면','보령우체국사서함'],
 '충청남도->서산시' : ['갈산동','덕지천동','동문동','석남동','석림동','수석동','양대동','예천동','오남동','온석동','읍내동','잠홍동','장동','죽성동','대산읍','고북면','부석면','성연면','운산면','음암면','인지면','지곡면','팔봉면','해미면','대산우체국사서함','서산우체국사서함'],
 '충청남도->아산시' : ['권곡동','기산동','남동','득산동','모종동','방축동','배미동','법곡동','신동','신인동','실옥동','온천1동','온천2동','온천동','용화동','읍내동','장존동','점양동','좌부동','초사동','풍기동','배방읍','염치읍','도고면','둔포면','선장면','송악면','신창면','영인면','음봉면','인주면','탕정면','아산우체국사서함'],
 '충청남도->천안시 동남구' : ['구룡동','구성동','다가동','대흥동','문화동','봉명동','사직동','삼룡동','성황동','신방동','신부동','안서동','영성동','오룡동','용곡동','원성1동','원성2동','원성동','유량동','청당동','청수동','목천읍','광덕면','동면','병천면','북면','성남면','수신면','풍세면','천안우체국사서함'],
 '충청남도->천안시 서북구' : ['두정동','백석동','부대동','불당동','성성동','성정1동','성정2동','성정동','신당동','쌍용1동','쌍용2동','쌍용3동','쌍용동','업성동','와촌동','차암동','성거읍','성환읍','직산읍','입장면'],
 '충청남도->금산군' : ['금산읍','군북면','금성면','남이면','남일면','복수면','부리면','제원면','진산면','추부면'],
 '충청남도->당진군' : ['당진읍','합덕읍','고대면','대호지면','면천면','석문면','송산면','송악면','순성면','신평면','우강면','정미면'],
 '충청남도->부여군' : ['부여읍','구룡면','규암면','남면','내산면','석성면','세도면','양화면','옥산면','외산면','은산면','임천면','장암면','초촌면','충화면','홍산면'],
 '충청남도->서천군' : ['서천읍','장항읍','기산면','마산면','마서면','문산면','비인면','서면','시초면','종천면','판교면','한산면','화양면'],
 '충청남도->연기군' : ['조치원읍','금남면','남면','동면','서면','소정면','전동면','전의면'],
 '충청남도->예산군' : ['삽교읍','예산읍','고덕면','광시면','대술면','대흥면','덕산면','봉산면','신암면','신양면','오가면','응봉면'],
 '충청남도->청양군' : ['청양읍','남양면','대치면','목면','비봉면','운곡면','장평면','정산면','청남면','화성면'],
 '충청남도->태안군' : ['안면읍','태안읍','고남면','근흥면','남면','소원면','원북면','이원면'],
 '충청남도->홍성군' : ['광천읍','홍성읍','갈산면','결성면','구항면','금마면','서부면','은하면','장곡면','홍동면','홍북면'],
 '충청북도->제천시' : ['강제동','고명동','고암동','교동','남천동','대랑동','동현동','두학동','명동','명지동','모산동','산곡동','서부동','신동','신백동','신월동','영천동','왕암동','의림동','자작동','장락동','중앙로1가','중앙로2가','천남동','청전동','하소동','화산동','흑석동','봉양읍','금성면','덕산면','백운면','송학면','수산면','청풍면','한수면','제천우체국사서함'],
 '충청북도->청주시 상당구' : ['금천동','남문로1가','남문로2가','남주동','내덕1동','내덕2동','내덕동','대성동','명암동','문화동','방서동','북문로1가','북문로2가','북문로3가','사천동','산성동','서문동','서운동','석교동','수동','영동','영운동','오동동','외남동','외평동','외하동','용담동','용암1동','용암2동','용암동','용정동','우암동','운동동','월오동','율량동','정북동','정상동','정하동','주성동','주중동','지북동','탑동','평촌동','청주우체국사서함'],
 '충청북도->청주시 흥덕구' : ['가경동','강서1동','강서2동','강서동','개신동','남촌동','내곡동','동막동','모충동','문암동','미평동','산남동','복대1동','복대2동','복대동','봉명1동','봉명2동','봉명동','분평동','비하동','사직1동','사직2동','사직동','사창동','상신동','서청주우체국사서함','서촌동','석곡동','석소동','성화동','송절동','송정동','수곡1동','수곡2동','수곡동','수의동','신대동','신봉동','신성동','신전동','신촌동','외북동','운천동','원평동','장성동','장암동','정봉동','죽림동','지동동','평동','향정동','현암동','화계동','휴암동'],
 '충청북도->충주시' : ['가주동','교현1동','교현2동','교현동','금릉동','단월동','달천동','목벌동','목행동','문화동','봉방동','성남동','성내동','성서동','안림동','연수동','용관동','용두동','용산동','용탄동','종민동','지현동','직동','충의동','충인동','칠금동','풍동','호암동','주덕읍','가금면','금가면','노은면','동량면','산척면','살미면','소태면','수안보면','신니면','앙성면','엄정면','이류면','충주우체국사서함'],
 '충청북도->괴산군' : ['괴산읍','감물면','문광면','불정면','사리면','소수면','연풍면','장연면','청안면','청천면','칠성면'],
 '충청북도->단양군' : ['단양읍','매포읍','가곡면','단성면','대강면','어상천면','영춘면','적성면'],
 '충청북도->보은군' : ['보은읍','내북면','마로면','산외면','삼승면','속리산면','수한면','장안면','탄부면','회남면','회인면'],
 '충청북도->영동군' : ['영동읍','매곡면','상촌면','심천면','양강면','양산면','용산면','용화면','추풍령면','학산면','황간면'],
 '충청북도->옥천군' : ['옥천읍','군북면','군서면','동이면','안남면','안내면','이원면','청산면','청성면'],
 '충청북도->음성군' : ['금왕읍','음성읍','감곡면','대소면','맹동면','삼성면','생극면','소이면','원남면'],
 '충청북도->증평군' : ['증평읍','도안면'],
 '충청북도->진천군' : ['진천읍','광혜원면','덕산면','문백면','백곡면','이월면','초평면'],
 '충청북도->청원군' : ['내수읍','오창읍','가덕면','강내면','강외면','남이면','남일면','낭성면','문의면','미원면','부용면','북이면','옥산면','현도면']
}
</script>